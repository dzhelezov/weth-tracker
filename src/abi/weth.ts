...
export const events = {
    ...
    Deposit: new LogEvent<([dst: string, wad: ethers.BigNumber] & {dst: string, wad: ethers.BigNumber})>(
        abi, '0xe1fffcc4923d04b559f4d29a8bfc6cda04eb5b0d3c460751c2402c5c5cc9109c'
    ),
    Withdrawal: new LogEvent<([src: string, wad: ethers.BigNumber] & {src: string, wad: ethers.BigNumber})>(
...
export const functions = {
    ...
    approve: new Func<[guy: string, wad: ethers.BigNumber], {guy: string, wad: ethers.BigNumber}, boolean>(
        abi, '0x095ea7b3'
    ),
    ...
    withdraw: new Func<[wad: ethers.BigNumber], {wad: ethers.BigNumber}, []>(
        abi, '0x2e1a7d4d'
    ),
